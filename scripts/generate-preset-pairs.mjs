...
const THEMES = [
  ...
  /* ===== 扩充主题:更多 KTV 高频情绪场景 ===== */
  { key: '暧昧', desc: '和某人关系不明不白、心动又心累' },
  { key: '分手复合', desc: '和前任重新走到一起、或者想挽回' },
  { key: '异地恋', desc: '和喜欢的人分隔两地、靠电话和视频维系' },
  { key: '心动瞬间', desc: '第一次见面的心动、某个瞬间突然喜欢上一个人' },
  { key: '错过', desc: '错过一个人、错过一班地铁、错过一个机会' },
  { key: '孤独', desc: '一个人的周末、一个人的生日、一个人吃饭' },
  { key: '思念', desc: '想念一个不在身边的人、想起一个许久未见的人' },
  { key: '放下', desc: '放下一个人、放下一段过去、学会释然' },
  { key: '深夜电话', desc: '深夜接到或打出的电话,说着平时不会说的话' },
  { key: '生日', desc: '一个人的生日、和朋友过的生日、生日里的心事' },
  { key: '跨年', desc: '跨年夜的画面:倒计时、烟火、许愿、想起某个人' },
  { key: '回家', desc: '坐火车/飞机回家的路上,想念家里的味道' },
  { key: '大城市打拼', desc: '北上广深、出租屋、地铁、梦想和现实' },
  { key: '梦想', desc: '坚持或放弃梦想、为梦想努力的画面' },
  { key: '闺蜜/兄弟', desc: '和闺蜜/兄弟的友情,一起哭一起笑' },
  { key: '父母', desc: '想对爸妈说的话、和爸妈的关系、长大后的体谅' },
];
